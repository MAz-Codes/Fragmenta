...
- **Reverb impulse responses** — the bundled convolution-reverb IRs under [`app/frontend/public/ir/`](app/frontend/public/ir/) are from the [Voxengo free Impulse Response pack](https://www.voxengo.com/impulses/). See [NOTICE.md](NOTICE.md) for terms.
