 ...
 * indicator). Stages with attached modules glow with the warm accent —
                    ...
                    <React.Fragment key={stageInfo.stage}>
                        ...
                        <Tooltip title={`${stageInfo.hint} Click to attach a bend module.`}>
                            <Badge
                                badgeContent={n || null}
                                sx={{ '& .MuiBadge-badge': {
                                    backgroundColor: warm, color: '#1A0F00',
                                    fontWeight: 600,
                                } }}
                            >
                                <ButtonBase
                                    ...
                                    sx={{
                                        ...
                                        border: '1px solid',
                                        borderColor: active ? warm : 'divider',
                                        boxShadow: active ? `0 0 12px ${warm}55, inset 0 0 6px ${warm}22` : 'none',
                                        transition: 'border-color 220ms ease, box-shadow 220ms ease',
                                        '&:hover': {
                                            borderColor: active ? warm : 'primary.main',
                                ...
                                >
                                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                                        <Typography variant="subtitle2" sx={{
                                            color: active ? warm : 'text.primary',
