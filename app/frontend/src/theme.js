...
// with body Inter. Variable weights 400–700 — condensed, editorial.
const FONT_DISPLAY = '"Oswald", "Inter", system-ui, sans-serif';
...
let theme = createTheme({
    ...
    typography: {
        ...
        // Tier-1 section card titles — Oswald at semibold for clean
        // condensed presence without dominating the cards.
        h6: { fontFamily: FONT_DISPLAY, fontWeight: 600, letterSpacing: '0.005em', fontSize: '1.15rem' },
        // Tier-2 section/accordion labels — same Oswald, same weight,
        // slightly smaller. "Annotator Labels", "Advanced Settings",
        // "Edit existing audio" all flow through here.
        subtitle1: { fontFamily: FONT_DISPLAY, fontWeight: 600, letterSpacing: '0.005em', fontSize: '1.02rem', textTransform: 'none' },
