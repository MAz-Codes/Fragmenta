...
- **Origin**: **Synthesised from scratch** for Fragmenta — early reflections
  plus a multiband exponentially-decaying diffuse tail, generated by a
  deterministic maintainer script. They contain no third-party recordings or
  samples and carry no external licensing; they are part of this AGPL-3.0
  project. (They replaced an earlier set of Voxengo IRs whose
  no-charge-distribution terms were incompatible with AGPL-3.0.)
